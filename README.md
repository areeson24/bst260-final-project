...
4) Run `code/final-project.qmd` to produce final paper in HTML format that loads in rds objects from `plots/`.
5) Run `code/supp-materials.qmd` to produce supplementary tables and figures in HTML format that also loads in rds objects from `plots/`.
